...
DEFAULT_MODEL_ID="${MIS_EMBED_MODEL_ID:-multilingual-e5-small}"
MODEL_DIR="${MIS_EMBED_MODEL_DIR:-$ROOT_DIR/models/embed/$DEFAULT_MODEL_ID}"
MIS_HOST="${MIS_HOST:-0.0.0.0}"
MIS_PORT="${MIS_PORT:-8005}"

export MIS_EMBED_BACKEND="${MIS_EMBED_BACKEND:-onnx}"
export MIS_EMBED_MODEL_ID="$DEFAULT_MODEL_ID"
...
export MIS_TIMEOUT_MS="${MIS_TIMEOUT_MS:-5000}"
