...
def compare_with_baseline(
    ...
    *,
    ...
    baseline_increase_pairs = [
        ("high_conflict_unqueued_total", max_high_conflict_unqueued_total_increase),
        ("missing_operator_note_total", max_missing_operator_note_total_increase),
    ]
    ...
    baseline_ratio_drop_pairs = [
        ("high_queue_coverage_ratio", max_high_queue_coverage_ratio_drop),
        ("resolved_ratio", max_resolved_ratio_drop),
    ]
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-high-conflict-unqueued-total-increase", type=int, default=0)
    ...
    parser.add_argument("--max-missing-operator-note-total-increase", type=int, default=0)
...
def main() -> int:
    ...
    if args.baseline_report:
        ...
        baseline_failures = compare_with_baseline(
            ...
            max_high_conflict_unqueued_total_increase=max(0, int(args.max_high_conflict_unqueued_total_increase)),
            ...
            max_missing_operator_note_total_increase=max(0, int(args.max_missing_operator_note_total_increase)),
    ...
    payload = {
        ...
        "gate": {
            ...
            "thresholds": {
                ...
                "max_high_conflict_unqueued_total_increase": int(args.max_high_conflict_unqueued_total_increase),
                ...
                "max_missing_operator_note_total_increase": int(args.max_missing_operator_note_total_increase),
