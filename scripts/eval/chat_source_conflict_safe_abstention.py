...
def compare_with_baseline(
    ...
    *,
    max_should_abstain_total_drop: int,
    max_abstain_total_drop: int,
    max_unsafe_definitive_total_increase: int,
    max_abstain_compliance_ratio_drop: float,
    max_missing_standard_phrase_total_increase: int,
    max_missing_source_link_total_increase: int,
    max_missing_reason_code_total_increase: int,
    max_message_quality_ratio_drop: float,
    ...
    baseline_drop_pairs = [
        ("should_abstain_total", max_should_abstain_total_drop),
        ("abstain_total", max_abstain_total_drop),
    ]
    ...
    baseline_increase_pairs = [
        ("unsafe_definitive_total", max_unsafe_definitive_total_increase),
        ("missing_standard_phrase_total", max_missing_standard_phrase_total_increase),
        ("missing_source_link_total", max_missing_source_link_total_increase),
    ...
    baseline_ratio_drop_pairs = [
        ("abstain_compliance_ratio", max_abstain_compliance_ratio_drop),
        ("message_quality_ratio", max_message_quality_ratio_drop),
    ]
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-should-abstain-total-drop", type=int, default=10)
    parser.add_argument("--max-abstain-total-drop", type=int, default=10)
    parser.add_argument("--max-unsafe-definitive-total-increase", type=int, default=0)
    parser.add_argument("--max-abstain-compliance-ratio-drop", type=float, default=0.05)
    parser.add_argument("--max-missing-standard-phrase-total-increase", type=int, default=0)
    parser.add_argument("--max-missing-source-link-total-increase", type=int, default=0)
    parser.add_argument("--max-missing-reason-code-total-increase", type=int, default=0)
    parser.add_argument("--max-message-quality-ratio-drop", type=float, default=0.05)
...
def main() -> int:
    ...
    if args.baseline_report:
        ...
        baseline_failures = compare_with_baseline(
            baseline_payload,
            summary,
            max_should_abstain_total_drop=max(0, int(args.max_should_abstain_total_drop)),
            max_abstain_total_drop=max(0, int(args.max_abstain_total_drop)),
            max_unsafe_definitive_total_increase=max(0, int(args.max_unsafe_definitive_total_increase)),
            max_abstain_compliance_ratio_drop=max(0.0, float(args.max_abstain_compliance_ratio_drop)),
            max_missing_standard_phrase_total_increase=max(0, int(args.max_missing_standard_phrase_total_increase)),
            max_missing_source_link_total_increase=max(0, int(args.max_missing_source_link_total_increase)),
            max_missing_reason_code_total_increase=max(0, int(args.max_missing_reason_code_total_increase)),
            max_message_quality_ratio_drop=max(0.0, float(args.max_message_quality_ratio_drop)),
    ...
    payload = {
        ...
        "gate": {
            ...
            "thresholds": {
                ...
                "max_should_abstain_total_drop": int(args.max_should_abstain_total_drop),
                "max_abstain_total_drop": int(args.max_abstain_total_drop),
                "max_unsafe_definitive_total_increase": int(args.max_unsafe_definitive_total_increase),
                "max_abstain_compliance_ratio_drop": float(args.max_abstain_compliance_ratio_drop),
                "max_missing_standard_phrase_total_increase": int(args.max_missing_standard_phrase_total_increase),
                "max_missing_source_link_total_increase": int(args.max_missing_source_link_total_increase),
                "max_missing_reason_code_total_increase": int(args.max_missing_reason_code_total_increase),
                "max_message_quality_ratio_drop": float(args.max_message_quality_ratio_drop),
