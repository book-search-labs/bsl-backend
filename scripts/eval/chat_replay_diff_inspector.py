...
def compare_with_baseline(
    ...
    *,
    max_divergence_detected_total_drop: int,
    max_first_divergence_total_drop: int,
    max_missing_first_divergence_total_increase: int,
    max_unknown_divergence_type_total_increase: int,
    max_invalid_step_total_increase: int,
    ...
    baseline_drop_pairs = [
        ("divergence_detected_total", max_divergence_detected_total_drop),
        ("first_divergence_total", max_first_divergence_total_drop),
    ]
    ...
    baseline_increase_pairs = [
        ("missing_first_divergence_total", max_missing_first_divergence_total_increase),
        ("unknown_divergence_type_total", max_unknown_divergence_type_total_increase),
        ("invalid_step_total", max_invalid_step_total_increase),
    ]
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-divergence-detected-total-drop", type=int, default=10)
    parser.add_argument("--max-first-divergence-total-drop", type=int, default=10)
    parser.add_argument("--max-missing-first-divergence-total-increase", type=int, default=0)
    parser.add_argument("--max-unknown-divergence-type-total-increase", type=int, default=0)
    parser.add_argument("--max-invalid-step-total-increase", type=int, default=0)
...
def main() -> int:
    ...
    if args.baseline_report:
        ...
        baseline_failures = compare_with_baseline(
            baseline_payload,
            summary,
            max_divergence_detected_total_drop=max(0, int(args.max_divergence_detected_total_drop)),
            max_first_divergence_total_drop=max(0, int(args.max_first_divergence_total_drop)),
            max_missing_first_divergence_total_increase=max(0, int(args.max_missing_first_divergence_total_increase)),
            max_unknown_divergence_type_total_increase=max(0, int(args.max_unknown_divergence_type_total_increase)),
            max_invalid_step_total_increase=max(0, int(args.max_invalid_step_total_increase)),
    ...
    payload = {
        ...
        "gate": {
            ...
            "thresholds": {
                ...
                "max_divergence_detected_total_drop": int(args.max_divergence_detected_total_drop),
                "max_first_divergence_total_drop": int(args.max_first_divergence_total_drop),
                "max_missing_first_divergence_total_increase": int(args.max_missing_first_divergence_total_increase),
                "max_unknown_divergence_type_total_increase": int(args.max_unknown_divergence_type_total_increase),
                "max_invalid_step_total_increase": int(args.max_invalid_step_total_increase),
