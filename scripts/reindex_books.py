...
INDEX_PREFIX = os.environ.get("BOOKS_DOC_INDEX_PREFIX", "books_doc_v2_1_local")
MAPPING_FILE = Path(
    os.environ.get("BOOKS_DOC_MAPPING", ROOT_DIR / "infra/opensearch/books_doc_v2_1.mapping.json")
)
