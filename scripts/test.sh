...
echo "[99/103] Chat temporal conflict fallback gate (optional)"
...
echo "[100/103] Chat correction memory schema gate (optional)"
...
echo "[101/103] Canonical quality checks (optional)"
...
echo "[102/103] E2E tests (optional)"
if [ "${RUN_E2E:-0}" = "1" ]; then
  if [ -n "$PYTHON_BIN" ]; then
