...
SCHEMA_FILES = {
    ...
    "commerce-checkout-start-request.sample.json": CONTRACTS_DIR / "commerce-checkout-start-request.schema.json",
    "commerce-checkout-action-request.sample.json": CONTRACTS_DIR / "commerce-checkout-action-request.schema.json",
    "commerce-checkout-response.sample.json": CONTRACTS_DIR / "commerce-checkout-response.schema.json",
    "commerce-checkout-list-response.sample.json": CONTRACTS_DIR / "commerce-checkout-list-response.schema.json",
    "commerce-checkout-action-response.sample.json": CONTRACTS_DIR / "commerce-checkout-action-response.schema.json",
    "commerce-refund-create-request.sample.json": CONTRACTS_DIR / "commerce-refund-create-request.schema.json",
    "commerce-refund-response.sample.json": CONTRACTS_DIR / "commerce-refund-response.schema.json",
    "commerce-refund-list-response.sample.json": CONTRACTS_DIR / "commerce-refund-list-response.schema.json",
