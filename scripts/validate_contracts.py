...
SCHEMA_FILES = {
    ...
    "chat-rollout-snapshot-response.sample.json": CONTRACTS_DIR / "chat-rollout-snapshot-response.schema.json",
    "chat-rollout-reset-request.sample.json": CONTRACTS_DIR / "chat-rollout-reset-request.schema.json",
    "chat-rollout-reset-response.sample.json": CONTRACTS_DIR / "chat-rollout-reset-response.schema.json",
