...
- infra/opensearch/books_doc_v2_1.mapping.json을 기반으로 새 books 인덱스를 생성합니다.
...
- `BOOKS_DOC_INDEX_PREFIX` (default `books_doc_v2_1_local`)
- `BOOKS_DOC_MAPPING` (default `infra/opensearch/books_doc_v2_1.mapping.json`)
