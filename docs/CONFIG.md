...
- `BFF_SESSION_HEADER`, `BFF_SESSION_TTL_SECONDS`, `BFF_SESSION_KEY_PREFIX`
- `BFF_ENFORCE_USER_API`, `BFF_USER_API_PREFIX`
...
- `RANKING_BASE_URL`
- `EMBEDDING_MODE`, `EMBEDDING_BASE_URL`, `EMBEDDING_MODEL`
...
- `OUTBOX_RELAY_TOPIC_MATERIAL_UPSERT_REQUESTED`, `OUTBOX_RELAY_TOPIC_MATERIAL_DELETE_REQUESTED`

FastAPI (shared):
- `BSL_ENV`, `BSL_TENANT_ID`, `BSL_LOCALE`, `BSL_TIMEZONE`
- `CORS_ALLOW_ORIGINS`, `CORS_ALLOW_ORIGIN_REGEX`
- `NORMALIZATION_RULES_PATH` (optional)
- `MIS_EMBED_BACKEND`, `MIS_EMBED_MODEL_ID`, `MIS_DEFAULT_EMBED_MODEL`
- `MIS_EMBED_MODEL_PATH`, `MIS_EMBED_TOKENIZER_PATH`, `MIS_EMBED_MAX_LEN`
...
- `OS_SYNC_ENABLED`, `OS_SYNC_TOPIC`, `OS_SYNC_GROUP_ID`, `OS_SYNC_HANDLER`
- `OS_SYNC_POLL_TIMEOUT_SEC`, `OS_SYNC_CONSUMER_BATCH_SIZE`
- `OS_SYNC_RETRY_MAX`, `OS_SYNC_RETRY_BACKOFF_SEC`
- `OS_SYNC_DLQ_ENABLED`, `OS_SYNC_DLQ_SUFFIX`
- `OS_SYNC_RECONCILE_ENABLED`, `OS_SYNC_RECONCILE_INTERVAL_SEC`
- `OS_SYNC_RECONCILE_BATCH_SIZE`, `OS_SYNC_RECONCILE_MAX_ENQUEUE`
- `OS_SYNC_RECONCILE_CHECKPOINT_NAME`
