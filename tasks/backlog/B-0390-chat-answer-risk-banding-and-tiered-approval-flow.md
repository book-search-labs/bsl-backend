...
- [x] Answer band policy guard gate 추가
  - `scripts/eval/chat_answer_band_policy_guard.py`
  - 고위험 응답의 금지/필수 문구 및 safe policy coverage 검증
  - R3 실행 claim 위반 및 handoff 누락 검증
- [x] 단위 테스트 추가
