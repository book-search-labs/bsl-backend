...
- [x] Korean runtime normalization guard gate 추가
  - `scripts/eval/chat_korean_runtime_normalization_guard.py`
  - term/style normalization 적용률, 의미 드리프트, 과도 수정 fallback 누락 검증
  - p95 edit ratio 및 reason_code 누락 검증
- [x] 단위 테스트 추가
