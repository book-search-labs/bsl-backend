...
@Component
@ConfigurationProperties(prefix = "search.cache.book")
public class BookCacheProperties {
    private boolean enabled = true;
    private long ttlMs = 60000;
    private int maxEntries = 2000;
    private String keyPrefix = "book:";
    private int cacheControlMaxAgeSeconds = 60;
    ...
    public void setCacheControlMaxAgeSeconds(int cacheControlMaxAgeSeconds) {
