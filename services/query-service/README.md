...
# QS_CHAT_RECOMMEND_EXPERIMENT_ENABLED=0
# QS_CHAT_RECOMMEND_EXPERIMENT_DIVERSITY_PERCENT=50
# QS_CHAT_RECOMMEND_EXPERIMENT_MIN_SAMPLES=20
# QS_CHAT_RECOMMEND_EXPERIMENT_MAX_BLOCK_RATE=0.4
# QS_CHAT_RECOMMEND_EXPERIMENT_AUTO_DISABLE_SEC=600
# QS_CHAT_RECOMMEND_QUALITY_MIN_CANDIDATES=2
# QS_CHAT_RECOMMEND_QUALITY_MIN_DIVERSITY=2
# QS_CHAT_EPISODE_MEMORY_ENABLED=1
# QS_CHAT_EPISODE_MEMORY_DEFAULT_OPT_IN=0
# QS_CHAT_EPISODE_MEMORY_TTL_SEC=2592000
# QS_CHAT_EPISODE_MEMORY_MAX_ITEMS=5
# QS_CHAT_EPISODE_MEMORY_PROMPT_ITEMS=3
# QS_CHAT_EPISODE_MEMORY_MAX_FACT_LEN=120
